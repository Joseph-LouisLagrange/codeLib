...
public class PinYin4jUtils {
	 ...
	 * @return
	 */
	public static char[] getHeadByString(String src) {
		String[] temp=getHeadByString(src, false);
		char[] headChars=new char[temp.length];
		for(int i=0;i<temp.length;i++) {
			headChars[i]=temp[i].charAt(0);
		}
		return headChars;
	}
	...
	public static void main(String[] args) {
		// pin4j 简码 和 城市编码 
		String s1 = "啊音乐人民共和国111"; 
		char[] headArray = getHeadByString(s1); // 获得每个汉字拼音首字母
		System.out.println(headArray[0]);
		String s2 ="11长城" ; 
		System.out.println(Arrays.toString(stringToPinyin(s2,false,"")));
		String s3 ="长";
		System.out.println(Arrays.toString(stringToPinyin(s3,false,"")));
	}
}
